...
public:
    ...
    Pistache::Http::Code transact(string &srcname, string& destname, double amt, string& resp);
    
    Pistache::Http::Code getToken(string& srcname, string& destname, double amt, string& token);
